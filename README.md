...
## View Owned and Subscribed Experiments
1. Select the "MY EXPERIMENTS" button
2. This will open on a screen displaying all experiments that you created.
3. To view experiments that you are subscribed to, select the "SUBSCRIBED EXPERIMENTS" tab at the top of the screen
